...
import { Circle, StarIcon, CircleCheckBig, SettingsIcon } from 'lucide-react-native';
    ...
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Home',
          headerShown: false,
          tabBarIcon: ({ color, size }) => <Icon as={Circle} size={size} color={color} />,
        }}
      />
      <Tabs.Screen
        name="recommend"
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Timeline',
          headerShown: false,
          tabBarIcon: ({ color, size }) => <Icon as={CircleCheckBig} size={size} color={color} />,
        }}
      />
      <Tabs.Screen
        name="settings"
